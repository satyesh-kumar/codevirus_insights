...
const CreateQuestionModal: React.FC<CreateQuestionModalProps> = ({ onClose, onSubmit, user, theme }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
      ...
      <div className={`w-full max-w-xl rounded-xl shadow-2xl overflow-hidden relative animate-in fade-in zoom-in duration-200 border ${
        ...
        <div className="p-6">
          <div className={`flex items-center gap-3 mb-6 p-4 rounded-xl border ${
            theme === 'dark' ? 'bg-blue-900/20 border-blue-900/50 text-blue-300' : 'bg-blue-50 border-blue-100 text-blue-800'
          }`}>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <select 
              ...
              className={`border-none rounded-full px-3 py-1 text-xs font-bold focus:ring-2 focus:ring-blue-500 cursor-pointer outline-none ${
          ...
          <textarea 
            ...
            className={`w-full text-xl font-bold border-none focus:ring-0 placeholder:text-slate-300 dark:placeholder:text-slate-600 resize-none mb-4 outline-none min-h-[80px] bg-transparent ${
          ...
          <textarea 
            ...
            className={`w-full text-sm border-none focus:ring-0 placeholder:text-slate-300 dark:placeholder:text-slate-600 resize-none outline-none min-h-[100px] bg-transparent ${
